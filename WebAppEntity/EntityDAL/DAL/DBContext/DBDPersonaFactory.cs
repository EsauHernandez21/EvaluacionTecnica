...
namespace EntityDAL.DAL.DBContext
{
    ...
    public class DBDPersonaFactory : IDesignTimeDbContextFactory<DBDPersona>
    {
        public DBDPersona CreateDbContext(string[]? args = null)
        {
            ...
            var optionsBuilder = new DbContextOptionsBuilder<DBDPersona>();
            ...
            return new DBDPersona(optionsBuilder.Options);
        }
    }
}
